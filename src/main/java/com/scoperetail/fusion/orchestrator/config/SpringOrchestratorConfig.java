...
public class SpringOrchestratorConfig {
  ...
  private static final String PICKING_SUB_SYSTEM_ORDER_COMPLETE_MESSAGE_V1_0_XSD =
      "PickingSubSystemOrderCompleteMessage_V1.0.xsd";
  private static final String PICKING_ORDER_BEGIN_EVENT_V1_0_XSD =
      "PickingOrderBeginEvent_V1.0.xsd";
